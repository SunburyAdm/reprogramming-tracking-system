...
const T = {
  en: {
    ...
    noTemplates: 'No templates saved yet — fill in the New Session form and click "Save as template".',
    templateLimitReached: 'Limit reached (10 / 10). Delete a template to save more.',
  ...
  es: {
    ...
    sessionTemplates: '📁 Templates de Sesión',
    noTemplates: 'Aún no hay templates — rellena el formulario de Nueva Sesión y haz clic en "Guardar como template".',
    templateLimitReached: 'Límite alcanzado (10 / 10). Elimina un template para poder guardar más.',
